...
static u8 Local_u8SSDPart[8]  = SSD_SPECIFIC_PART_ARR;
//====================================================================================================================================================
/*
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
/*
 * Brief: this function write Part on 7 seg [a : g]
 * Parameters :=> struct has the SSD tybe ,data Port and enable (Port &Pin)
 * return :void
 *
 * */
