...
/******************************************************************************/
/*                                                                            */
/* !Designed by     : Islam Mohamed Abdullah                      !Date : NOV 25, 2023 */
...
SW_Type L_SW ={DIO_PORTB,DIO_PIN7,SW_Int_PULL_UP};
SW_Type H_SW ={DIO_PORTB,DIO_PIN6,SW_Int_PULL_UP};
SW_Type R_SW ={DIO_PORTB,DIO_PIN5,SW_Int_PULL_UP};


SSD_Type L_SSD={SSD_COMMON_CATHODE,SSD_PORTC,SSD_PORTB,SSD_PIN7};
...
static void vidInit(void)
{
	/*! Initialize HAL layer                    LCD,SW,SSD                              */
	SW_voidInit(R_SW);
	SW_voidInit(L_SW);
	SW_voidInit(H_SW);
